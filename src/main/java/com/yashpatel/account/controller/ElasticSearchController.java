package com.yashpatel.account.controller;
...
import com.yashpatel.account.service.UserService;
import com.yashpatel.account.utils.ElasticsearchUtil;
...
public class ElasticSearchController {
    ...
    public String insert(final Model model) throws IOException {
         ...
         * ElasticsearchUtil.trannsportClient().index(indexRequest).actionGet();
     ...
     * ElasticsearchUtil.trannsportClient().prepareGet("users", "user"
     * ,String.valueOf(user.getId())).get();
     * System.out.println(getResponse.getSource());
     * 
     ...
     * + "}";
     * IndexResponse response =
     * ElasticsearchUtil.trannsportClient().prepareIndex("users", "data")
